...
$(function() {
    ...
    describe("RSS feeds", function() {
         ...
         */
        it("each feed has an URL defined and the URL is not empty", function() {
            allFeeds.forEach(function(feed) {
    ...
    describe("Initial entries", function() {
        ...
        it("are loaded and there is at least a single element", function() {
    ...
    describe("New feed selection", function() {
        ...
        it("loads different content", function() {
            expect($(".feed").last().html()).not.toBe(firstFeed);
        });
    });
}());